...
.datepicker {
  ...
  button.next--mobile {
    ...
    &:after {
      background: transparent url("./images/ic-arrow-right-green.regular.svg")
  ...
  &__wrapper {
    ...
    width: 100%;
    height: 48px;
    background: $white url("./images/calendar_icon.regular.svg") no-repeat 17px
      center / 16px;
  }
  ...
  &__input {
    ...
    &:first-child {
      background: transparent
        url("./images/ic-arrow-right-datepicker.regular.svg") no-repeat right
        center / 8px;
      width: calc(50% - 4px);
      text-indent: 20px;
    }
